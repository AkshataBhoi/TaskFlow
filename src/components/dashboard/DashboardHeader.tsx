...
function OwlMascot() {
  return (
    ...
    >
      {/* Body */}
      <ellipse cx="60" cy="76" rx="30" ry="32" fill="#3B82F6" />

      {/* Belly */}
      <ellipse cx="60" cy="82" rx="18" ry="22" fill="#DBEAFE" />

      {/* Head */}
      <circle cx="60" cy="44" r="28" fill="#3B82F6" />

      {/* Ear Tufts */}
      <polygon points="37,22 42,36 32,36" fill="#2563EB" />
      <polygon points="83,22 88,36 78,36" fill="#2563EB" />
      ...
      {/* Pupils */}
      <circle cx="49" cy="44" r="7" fill="#0F172A" />
      <circle cx="71" cy="44" r="7" fill="#0F172A" />
      ...
      {/* Beak */}
      <polygon points="60,50 55,57 65,57" fill="#1D4ED8" />
      ...
      {/* Belly Pattern */}
      <ellipse cx="60" cy="78" rx="7" ry="4" fill="#93C5FD" opacity="0.8" />
      <ellipse cx="60" cy="86" rx="5" ry="3" fill="#93C5FD" opacity="0.8" />
    </svg>
  );
}
...
export function DashboardHeader() {
  ...
  return (
    ...
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50 border border-blue-100 shadow-sm">
      ...
      <div className="absolute top-0 right-0 w-64 h-64 bg-blue-100 rounded-full -translate-y-1/2 translate-x-1/3 opacity-40 pointer-events-none" />

      <div className="absolute bottom-0 left-20 w-40 h-40 bg-indigo-100 rounded-full translate-y-1/2 opacity-30 pointer-events-none" />
      ...
      <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-6 px-7 py-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-2xl font-semibold text-blue-700 uppercase tracking-wider mb-0.5">
        ...
        <div className="hidden md:flex items-end gap-4">
          ...
          <div className="flex flex-col items-end gap-2 mb-2">
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white/90 backdrop-blur-sm border border-blue-200 rounded-full text-xs font-semibold text-blue-700 shadow-sm">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
              Productive mode on
            </div>

            <p className="text-xs text-slate-500 font-medium">
              Your companion is watching 🦉
            </p>
          </div>
